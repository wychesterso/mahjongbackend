                ...
                for (int j = i + 1; j < numFlowers; j++) {
                    for (int k = j + 1; k < numFlowers; k++) {
                        for (int l = k + 1; l < numFlowers; l++) {
                            ...
                            if (tileNums.size() == 4
                                    && !TileHelper.checkSameType(List.of(tile1, tile2,
                                    tile3, tile4))) {
                                count += 1;
                            }
                        }
