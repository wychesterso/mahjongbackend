...
public enum ScoringPattern {
    ...
    GOOD_FLOWER("正花", "Flower corresponding to seat", 2),
    BAD_FLOWER("爛花", "Flower not corresponding to seat", 1),
    ...
    GOOD_PAIR("將眼", "Pair is 2/5/8", 1),
    FRONT_AND_BACK("老少", "123 and 789, or 111 and 999, same type", 2),
